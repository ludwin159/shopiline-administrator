...
function ListaPedidosPendienteEntrega(props){
    const Id = props.Id;
    ...
    const actualizarEntregado= async()=>{
    ...
    return(
        ...
        <div className="container-pedido" >
            <div className="container-pedido" ref={ref}>
            ...
            <button onClick={actualizarEntregado} className="confirmarPedidoEntrega">PEDIDO ENTREGADO</button>

            <Pdf targetRef={ref} filename="pedido.pdf" options={ {unit: "in"}} x={.5} y={.5} scale={0.8} >
                {({toPdf})=> <button className="confirmarPedidoEntrega" onClick={toPdf}>PDF PEDIDO</button>}
...
export default ListaPedidosPendienteEntrega;